...
export default function AddCustomer({ refresh }: { refresh: () => void }) {
            ...
            <form className="flex flex-col gap-2" onSubmit={handleSubmitCustomer(onCreateCustomer)}>
                ...
                <div className="grow">
                    ...
                    <TextInput
                        ...
                        helperText={
                            <>
                                {customerFormError.telephone && <span className="font-medium text-sm">{customerFormError.telephone.message}</span>}
                            </>
                        }
                    />
                </div>
    ...
    // return content;
    return (
        <Popover content={content} className="z-50">
